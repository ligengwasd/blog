...
// 记录方法参数信息。
// ParamNameResolver内置一个属性 SortedMap<Integer, String> names记录了参数位置和名称的对应关系
...
public Object execute(SqlSession sqlSession, Object[] args) {
  ...
  switch (command.getType()) {
    case INSERT: {
        // 使用ParamNameResolver把方法参数转化为SQL语句参数
   Object param = method.convertArgsToSqlCommandParam(args);
        // 调用SQLSession的insert方法，并处理结果
